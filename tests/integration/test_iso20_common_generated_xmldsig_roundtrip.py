"""Integration roundtrip over generator-produced ISO20_COMMON Xmldsig payloads.

Enumerates the members of the `iso20_xmldsigFragment` union and roundtrips
each at minimal + maximal, with per-XSD-choice-branch coverage driven by
the manifest in `tools/codegen/iso20_common_choices.py`.
"""
...
def _discover_xmldsig_members():
    spec = _SPECS["iso20_xmldsigFragment"]
