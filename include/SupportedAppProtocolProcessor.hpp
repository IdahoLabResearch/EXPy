...
#ifndef SUPPORTED_APP_PROTOCOL_PROCESSOR_HPP
#define SUPPORTED_APP_PROTOCOL_PROCESSOR_HPP

#include <nlohmann/json.hpp>
using json = nlohmann::json;

json getJson_AppProtocolType(const struct appHand_AppProtocolType& AppProtocolTypeDoc);
struct appHand_AppProtocolType getDoc_AppProtocolType(const json& AppProtocolTypeJson);
...
json getJson_exiDocument(const struct appHand_exiDocument& exiDocumentDoc);
struct appHand_exiDocument getDoc_exiDocument(const json& exiDocumentJson);
...
#endif // SUPPORTED_APP_PROTOCOL_PROCESSOR_HPP
