...
#include <common.hpp>
#include "ISO20ACDPProcessor.hpp"
...
// Marshalers — generated by tools/codegen from iso20_ACDP_Datatypes.h.
#include "generated/ISO20ACDP_marshalers.generated.cpp"
...
extern "C" {
    ...
    decoded_data* decodeFromPythonBytes(const uint8_t* data, size_t size) {
        try {
            ...
            json outJson = getJson_acdp_exiDocument(outDoc);
    ...
    encoded_data* encodeFromPythonDict(const char* inString) {
        try {
            ...
            iso20_acdp_exiDocument inDoc;
            inDoc = getDoc_acdp_exiDocument(inJson);
            ...
            int rc = encode_iso20_acdp_exiDocument(&outEXI, &inDoc);
