...
// Marshalers — generated by tools/codegen from iso20_DC_Datatypes.h.
#include "generated/ISO20DC_marshalers.generated.cpp"
...
extern "C" {
    ...
    decoded_data* decodeFromPythonBytes(const uint8_t* data, size_t size) {
        try {
            ...
            json outJson = getJson_dc_exiDocument(outDoc);
    ...
    encoded_data* encodeFromPythonDict(const char* inString) {
        try {
            ...
            iso20_dc_exiDocument inDoc;
            inDoc = getDoc_dc_exiDocument(inJson);
            ...
            int rc = encode_iso20_dc_exiDocument(&outEXI, &inDoc);
    ...
    decoded_data* decode_fragment_FromPythonBytes(const uint8_t* data, size_t size) {
        try {
            iso20_dc_exiFragment outDoc;
            exi_bitstream_t inEXI;

            exi_bitstream_init(&inEXI, const_cast<uint8_t*>(data), size, 0, nullptr);
            int rc = decode_iso20_dc_exiFragment(&inEXI, &outDoc);
            ...
            json outJson = getJson_dc_exiFragment(outDoc);
    ...
    encoded_data* encode_fragment_FromPythonDict(const char* inString) {
        try {
            ...
            iso20_dc_exiFragment inDoc;
            inDoc = getDoc_dc_exiFragment(inJson);
            ...
            exi_bitstream_init(&outEXI, stream, 256, pos1, nullptr);
            int rc = encode_iso20_dc_exiFragment(&outEXI, &inDoc);
    ...
    decoded_data* decode_xmldsig_FromPythonBytes(const uint8_t* data, size_t size) {
        try {
            iso20_dc_xmldsigFragment outDoc;
            exi_bitstream_t inEXI;

            exi_bitstream_init(&inEXI, const_cast<uint8_t*>(data), size, 0, nullptr);
            int rc = decode_iso20_dc_xmldsigFragment(&inEXI, &outDoc);
            ...
            json outJson = getJson_dc_xmldsigFragment(outDoc);
    ...
    encoded_data* encode_xmldsig_FromPythonDict(const char* inString) {
        try {
            ...
            iso20_dc_xmldsigFragment inDoc;
            inDoc = getDoc_dc_xmldsigFragment(inJson);
            ...
            exi_bitstream_init(&outEXI, stream, 256, pos1, nullptr);
            int rc = encode_iso20_dc_xmldsigFragment(&outEXI, &inDoc);
