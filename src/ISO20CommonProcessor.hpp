...
// extern "C" surface for the ISO20_COMMON Namespace Processor. Symbol shape
// matches the other Processor `.so`s (see ISO2Processor.cpp, DINProcessor.cpp);
// once #23 lands, this hand-written header and the matching .cpp collapse into
// a single codegen template.
